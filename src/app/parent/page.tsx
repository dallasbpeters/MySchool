              ...
              <div className="grid mt-6 flex-1 auto-rows-min gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <MultipleSelector
                    ...
                    onChange={(selected) =>
                      setNewAssignment({ ...newAssignment, category: selected })
                    }
                    options={categories}
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <Button
                          type="button"
                          variant={
                            newLink.type === 'link' ? 'default' : 'outline'
                          }
                          size="sm"
                          onClick={() =>
                        ...
                        <Button
                          type="button"
                          variant={
                            newLink.type === 'video' ? 'default' : 'outline'
                          }
                          size="sm"
                          onClick={() =>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {assignment.assigned_children.map(
                            (childName, index) => (
                              <span
                                key={index}
                                className="bg-primary/30 text-foreground text-xs px-2 py-0.5 rounded-full leading-4"
                              >
                                {childName}
                              </span>
                            ),
