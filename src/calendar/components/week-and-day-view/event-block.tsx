...
const calendarWeekEventCardVariants = cva(
  'flex select-none flex-col gap-0.5 truncate whitespace-nowrap rounded-sm border px-2 py-1.5 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
  {
    variants: {
      color: {
    ...
    <DraggableEvent event={event}>
      <EventDetailsDialog event={event}>
        ...
        >
          ...
          {event.isAllDay && <p className="text-xs opacity-75">All day</p>}
        </div>
      </EventDetailsDialog>
    </DraggableEvent>
  )
