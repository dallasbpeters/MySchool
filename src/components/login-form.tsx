      ...
      if (currentMode === 'login') {
        ...
        if (role === 'student') {
          ...
          const { data: codeData, error: codeError } = await supabase
            ...
            .select('parent_id, child_name, used')
          ...
          if ((codeData as any).used) {
            throw new Error('This signup code has already been used')
          }

          parentId = (codeData as any).parent_id
          setName((codeData as any).child_name) // Use the name from the signup code
        }
        ...
        // If student signup, mark the code as used
