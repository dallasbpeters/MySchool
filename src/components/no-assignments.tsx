...
const NoAssignments = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      className={cn('absolute h-full w-full inset-0 z-0', className)}
    >
      <style>{`
...
`}</style>
      ...
      >
        ...
        <stop
          offset="4.035127e-02"
          style={{ stopColor: 'var(--color-primary/80)' }}
        />
        <stop offset="0.1436" style={{ stopColor: '#F4C9C7' }} />
        <stop
          offset="0.2621"
          style={{ stopColor: 'var(--color-primary/60)' }}
        />
        <stop
          offset="0.4034"
          style={{ stopColor: 'var(--color-primary/40)' }}
        />
      ...
      <path
        className="st1"
        d="M1254.5,1500h-105.6c-71.9-214.5-236.5-393.1-453.3-477.1c-25.8-10-38.5-38.9-28.6-64.7s38.9-38.5,64.7-28.6
	c80.7,31.3,156.3,74.5,224.5,128.3c67.6,53.3,126.9,116.2,176.1,186.8C1187.3,1323.3,1228.3,1409.4,1254.5,1500z"
      />
      <path
        className="st1"
        d="M2200,1165.5v109.2l-290.2,127c-6.5,2.8-13.3,4.2-20,4.2c-19.3,0-37.6-11.2-45.8-30
	c-11.1-25.3,0.5-54.8,25.8-65.8L2200,1165.5z"
      />
      <path
        className="st2"
        d="M1128.4,613.5c-8.7,6-18.5,8.9-28.3,8.9c-15.9,0-31.5-7.5-41.2-21.6c-27.5-39.9-61.8-75.6-100.9-107.5
	...
	C1156.8,566.7,1151.1,597.8,1128.4,613.5z"
      ...
      <path
        className="st3"
        d="M764.2,1189.3c-26,0-52-1.9-77.9-5.8c-93.2-14.1-179.9-53.5-250.8-114.2c-79.4-68-137.7-159.8-173.2-273.1
	...
	C890.4,1177.8,827.5,1189.3,764.2,1189.3z"
      ...
      <path
        className="st4"
        d="M1107.6,141.1c-12.6,98.2-43.4,188.4-92.1,270c-10.4,17.5-21.7,34.5-33.8,51.2c-7.6,10.5-15.5,20.8-23.8,30.9
	...
	h100.2C1115.5,48.7,1113.5,95.8,1107.6,141.1z"
      ...
      <path
        className="st5"
        d="M1316.5,1330.6c-16.6,0-32.8-8.2-42.3-23.2c-14.8-23.3-7.9-54.2,15.5-69l735.7-466.2
	c23.3-14.8,54.2-7.9,69,15.5c14.8,23.3,7.9,54.2-15.5,69l-735.7,466.2C1335,1328.1,1325.7,1330.6,1316.5,1330.6z"
      />
      <path
        className="st4"
        d="M1889.8,1405.8c-4.8,0-9.6-0.7-14.4-2.1c-26.5-7.9-41.5-35.8-33.5-62.3l162.4-541.4
	c7.9-26.4,35.8-41.5,62.3-33.5c26.5,7.9,41.5,35.8,33.5,62.3l-162.4,541.4C1931.2,1391.9,1911.3,1405.8,1889.8,1405.8z"
      />
      <path
        className="st6"
        d="M760.3,994.3c-10,25.8-38.9,38.5-64.7,28.6C606.8,988.4,513,971,416.8,971c-153.4,0-296.5,45-416.8,122.4V976.8
	c25-13.6,50.9-26.1,77.3-37.3C184.9,894,299.1,871,416.8,871c108.6,0,214.6,19.7,315,58.6C757.5,939.6,770.3,968.5,760.3,994.3z"
      ...
      <path
        className="st1"
        d="M2200,286.2v101.9c-116.1,22.2-227.4,33.3-332.9,33.3c-59.9,0-117.9-3.6-173.9-10.8
	...
	c9.4,13.1,23.2,30.8,41.6,51c36.3,39.8,98.9,98.1,190.9,149.4C1576.9,323.5,1867.5,352.8,2200,286.2z"
      ...
      <path
        className="st4"
        d="M1100,622.4c-17.1,0-33.8-8.8-43.1-24.7c-14-23.8-6.1-54.4,17.7-68.5l422.3-248.5c23.8-14,54.4-6.1,68.5,17.7
	c14,23.8,6.1,54.4-17.7,68.4l-422.3,248.5C1117.4,620.1,1108.7,622.4,1100,622.4z"
      />
      <path
        className="st7"
        d="M1316.5,1330.6c-3.5,0-7-0.4-10.6-1.1c-27-5.8-44.2-32.4-38.4-59.4l205.8-956.7c5.8-27,32.4-44.2,59.4-38.4
